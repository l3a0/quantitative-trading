...
# `CLAUDE.md` already requires a session to re-read a rollup whenever the base
# has moved, and that rule does the work this setting was doing, on the branches
