...
| A sweep that fails an open issue body naming a closed issue as a dependency | It cannot tell a stale claim from a satisfied one, and no form of it catches the class. Measured on 2026-09-18 over all 49 open bodies, against the eight [issue 52](https://github.com/l3a0/quantitative-trading/issues/52) corrects. Scoped to a paragraph carrying dependency wording, it flags 4 bodies and catches 2 of the eight. Scoped to the whole section under a heading naming dependencies, it flags 12 and catches 5. The two sets of catches are disjoint, and [issue 47](https://github.com/l3a0/quantitative-trading/issues/47) is caught by neither, because its stale sentence sits under a heading about what the issue is not. Seven of the 12 are correct bodies. [Issues 19](https://github.com/l3a0/quantitative-trading/issues/19) through 23 name #1 and #2 in the same `## Depends on` section that [issues 14](https://github.com/l3a0/quantitative-trading/issues/14) through 18 did, as needs a purchased series would still have to meet, which is true where "neither exists yet" was false. Separating those two needs a reader. |
